...
enum RelOp { EQ_OP, NE_OP, LT_OP, GT_OP, LE_OP, GE_OP, ULT_OP, ULE_OP, UGT_OP, UGE_OP };
...
public:
    ...
    JumpStm( NameExp* exp, TEMP::LabelList* jumps ) : Stm( JUMP ), exp( exp ), jumps( jumps ) {}
    void Print( FILE* out, int d ) const override;
...
public:
    ...
    CjumpStm( RelOp op, Exp* left, Exp* right, TEMP::Label* true_label, TEMP::Label* false_label )
        : Stm( CJUMP ), op( op ), left( left ), right( right ), true_label( true_label ), false_label( false_label ) {}
    void Print( FILE* out, int d ) const override;
...
public:
    ...
    BinopExp( BinOp op, Exp* left, Exp* right ) : Exp( BINOP ), op( op ), left( left ), right( right ) {}
    void Print( FILE* out, int d ) const override;
